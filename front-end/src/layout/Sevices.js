...
function Services() {
     ...
     return (
          <div className="flex flex-col  bg-primary  items-center p-3 gap-5 pb-12">
               ...
               <div className="order-2 sm:w-4/5 h-11 bg-secondary rounded-full flex justify-between ps-2 gap-2 pe-2">
                    <Button onClick={() => handleButtonClick('Web')} text="Web" className={`sm:w-96 w-20 h-11 text-darker  sm:text-xl text-sm text-center font-semibold bg-light ${activeButton === 'Web' ? 'bg-white' : 'bg-light'} rounded-full`} />
                    <Button onClick={() => handleButtonClick('Mobile')} text="Mobile" className={`sm:w-96 w-20 h-11 text-darker sm:text-xl text-sm text-center font-semibold  bg-light ${activeButton === 'Mobile' ? 'bg-white' : 'bg-light'} rounded-full`} />
                    <Button onClick={() => handleButtonClick('Desktop')} text="Desktop" className={`sm:w-96 w-20  h-11 text-darker text-center text-sm sm:text-xl font-semibold  bg-light ${activeButton === 'Desktop' ? 'bg-white' : 'bg-light'} rounded-full`} />
               </div>
               <div className="order-3 w-full sm:w-4/5 sm:min-h-fit">
